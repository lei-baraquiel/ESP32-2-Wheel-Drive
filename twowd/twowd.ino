...
<body>
  <h2>Robot Control</h2>
  <div><button class="btn" ontouchstart="send('forward')" ontouchend="send('stop')">▲</button></div>
  <div>
    <button class="btn" ontouchstart="send('left')" ontouchend="send('stop')">◀</button>
    <button class="btn" ontouchstart="send('right')" ontouchend="send('stop')">▶</button>
  </div>
  <div><button class="btn" ontouchstart="send('backward')" ontouchend="send('stop')">▼</button></div>
